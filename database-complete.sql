    ...
    CREATE TABLE
        ...
        flight_date_dmy VARCHAR(10) AS (
            CONCAT(LPAD(DAY(flight_date), 2, '0'), '/', LPAD(MONTH(flight_date), 2, '0'), '/', YEAR(flight_date))
        ) STORED,
        ...
        status ENUM('available', 'booked', 'cancelled', 'pending_approval') DEFAULT 'available',
        special_reason VARCHAR(255) NULL,
    ...
    -- ===== EXTRA TEST FLIGHTS (for search testing) =====
    -- Add flights dated 2025-09-24 across all three sites

    -- Hà Nội site extra flights
    USE flight_management_hanoi;
...
SELECT
    'HN2025001',
    (SELECT id FROM flights WHERE flight_code = 'VN001'),
    (SELECT id FROM customers WHERE email = 'an.nguyen@email.com'),
    'Nguyễn Văn An',
    'an.nguyen@email.com',
    '0123456789',
    'A1',
...
SELECT
    'HN2025002',
    (SELECT id FROM flights WHERE flight_code = 'VN003'),
    (SELECT id FROM customers WHERE email = 'binh.tran@email.com'),
    'Trần Thị Bình',
    'binh.tran@email.com',
    '0987654321',
    'B2',
...
SELECT
    'DN2025001',
    (SELECT id FROM flights WHERE flight_code = 'VN011'),
    (SELECT id FROM customers WHERE email = 'duc.pham@email.com'),
    'Phạm Văn Đức',
    'duc.pham@email.com',
    '0147258369',
    'C3',
...
SELECT
    'SG2025001',
    (SELECT id FROM flights WHERE flight_code = 'VN021'),
    (SELECT id FROM customers WHERE email = 'phuc.vo@email.com'),
    'Võ Văn Phúc',
    'phuc.vo@email.com',
    '0369258147',
    'D4',
...
SELECT
    'SG2025002',
    (SELECT id FROM flights WHERE flight_code = 'VN023'),
    (SELECT id FROM customers WHERE email = 'gia.dang@email.com'),
    'Đặng Thị Gia',
    'gia.dang@email.com',
    '0741852963',
    'E5',
